...
exports.removeTodo = exports.receiveTodo = exports.receiveTodos = exports.REMOVE_TODO = exports.RECEIVE_TODO = exports.RECEIVE_TODOS = exports.createTodo = exports.fetchTodos = undefined;

var _todo_api_util = __webpack_require__(176);

var _error_actions = __webpack_require__(179);
...
var createTodo = exports.createTodo = function createTodo(todo) {
  return function (dispatch) {
    return (0, _todo_api_util.APICreateTodo)(todo).then(function (responseTodo) {
      return dispatch(receiveTodo(responseTodo));
    }, function (err) {
...
var allTodos = function allTodos(state) {
  ...
  var todoArray = keys.map(function (key) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.GetApiTodos = _todo_api_util.GetApiTodos;
...
var _error_reducer = __webpack_require__(178);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = (0, _redux.combineReducers)({
  todos: _todos_reducer2.default,
  errors: _error_reducer.errorsReducer
});
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.todos.map(function (prop) {
            return _react2.default.createElement(_todo_list_item2.default, { key: prop.id, todo: prop, 'delete': _this2.props.removeTodo });
          })
        ),
      ...
      if (this.state.selected) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { onClick: function onClick() {
                return _this2.props.delete(_this2.props.todo);
              } },
            'Delete Item'
          )
        );
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { id: 'form-title-input',
            onChange: this.updateState("title"), type: 'text',
            value: this.state.title }),
          _react2.default.createElement('br', null),
          _react2.default.createElement(
            'label',
            { htmlFor: 'form-body-input' },
            'body'
          ),
          _react2.default.createElement('input', { id: 'form-body-input',
